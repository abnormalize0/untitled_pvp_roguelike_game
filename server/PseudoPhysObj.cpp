...
void PseudoPhysObj::add_impulses(std::vector<float> impulses) {
	impulse_x = impulse_x + impulses[0];
	impulse_y = impulse_y + impulses[1];
}

std::vector<float> PseudoPhysObj::return_collisions() {
